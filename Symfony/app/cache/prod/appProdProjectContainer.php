...
class appProdProjectContainer extends Container
{
    ...
    {
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_pgsql', 'host' => '10.43.16.145', 'port' => 5432, 'dbname' => 'symfony', 'user' => 'postgres', 'password' => 'Admpos1650.', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), new \Doctrine\DBAL\Configuration(), new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    {
        $a = new \Doctrine\ORM\Mapping\Driver\SimplifiedYamlDriver(array(($this->targetDirs[3].'/src/SesionesBundle/Resources/config/doctrine') => 'SesionesBundle\\Entity'));
        $a->setGlobalBasename('mapping');

        $b = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $b->addDriver($a, 'SesionesBundle\\Entity');

        $c = new \Doctrine\ORM\Configuration();
        $c->setEntityNamespaces(array('SesionesBundle' => 'SesionesBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_555b3b1dd5572e49a32a6d9e250f7c3c87437385384ceab56f499d82ad8d7e03');
    ...
    {
        return $this->services['form.csrf_provider'] = new \Symfony\Component\Form\Extension\Csrf\CsrfProvider\SessionCsrfProvider($this->get('session'), '831285cae7039925f7909f322b63f8f102622e41');
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/EjerciciosBundle/Resources/views'), 'Ejercicios');
        $instance->addPath(($this->targetDirs[3].'/src/SesionesBundle/Resources/views'), 'Sesiones');
        $instance->addPath(($this->targetDirs[3].'/src/AchaguaBundle/Resources/views'), 'Achagua');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('831285cae7039925f7909f322b63f8f102622e41');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('58936ac55fccd')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'EjerciciosBundle' => 'EjerciciosBundle\\EjerciciosBundle',
                'SesionesBundle' => 'SesionesBundle\\SesionesBundle',
                'AchaguaBundle' => 'AchaguaBundle\\AchaguaBundle',
                'FrontendBundle' => 'FrontendBundle\\FrontendBundle',
            ),
            'kernel.charset' => 'UTF-8',
            'kernel.container_class' => 'appProdProjectContainer',
            'database_driver' => 'pdo_pgsql',
            'database_host' => '10.43.16.145',
            'database_port' => 5432,
            'database_name' => 'symfony',
            'database_user' => 'postgres',
            'database_password' => 'Admpos1650.',
            'mailer_transport' => 'smtp',
            'mailer_host' => '127.0.0.1',
            'mailer_user' => NULL,
            'mailer_password' => NULL,
            'locale' => 'en',
            'secret' => '831285cae7039925f7909f322b63f8f102622e41',
            ...
            'kernel.secret' => '831285cae7039925f7909f322b63f8f102622e41',
