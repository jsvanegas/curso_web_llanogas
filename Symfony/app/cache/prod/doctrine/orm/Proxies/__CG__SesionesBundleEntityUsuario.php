 ...
 */
class Usuario extends \SesionesBundle\Entity\Usuario implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'SesionesBundle\\Entity\\Usuario' . "\0" . 'idUsuario', '' . "\0" . 'SesionesBundle\\Entity\\Usuario' . "\0" . 'nombre', '' . "\0" . 'SesionesBundle\\Entity\\Usuario' . "\0" . 'correo', '' . "\0" . 'SesionesBundle\\Entity\\Usuario' . "\0" . 'clave');
        }
    ...
    public function serializar()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'serializar', array());

        return parent::serializar();
    }
